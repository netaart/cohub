...
// after `vite build`; `src/entry.worker-deps.d.ts` types it and references this
// file, which sits outside the generated tsconfig `include`. The request logic
// lives in `src/lib/server/standalone-host-request.ts`.
...
import { serveStandaloneHostRequest } from "./src/lib/server/standalone-host-request.ts";
