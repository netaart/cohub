...
WORKSPACE_USAGE_ENABLED=$(get_value "WORKSPACE_USAGE_ENABLED")
WORKSPACE_USAGE_THREADS=$(get_value "WORKSPACE_USAGE_THREADS")
WORKSPACE_USAGE_CONCURRENCY=$(get_value "WORKSPACE_USAGE_CONCURRENCY")
WORKSPACE_USAGE_TIMEOUT_MS=$(get_value "WORKSPACE_USAGE_TIMEOUT_MS")
WORKSPACE_USAGE_MIN_SCAN_INTERVAL_MS=$(get_value "WORKSPACE_USAGE_MIN_SCAN_INTERVAL_MS")
WORKSPACE_USAGE_BATCH_SIZE=$(get_value "WORKSPACE_USAGE_BATCH_SIZE")
...
GENERATION_BASE_URL=$(get_value "GENERATION_BASE_URL")
...
SANDBOX_IDLE_REAPER_LIMIT=${SANDBOX_IDLE_REAPER_LIMIT:-50}
...
PY
  ...
  sed -i.bak \
    ...
    -e "s|__WORKSPACE_USAGE_ENABLED__|${WORKSPACE_USAGE_ENABLED:-true}|g" \
    -e "s|__WORKSPACE_USAGE_THREADS__|${WORKSPACE_USAGE_THREADS:-1}|g" \
    -e "s|__WORKSPACE_USAGE_CONCURRENCY__|${WORKSPACE_USAGE_CONCURRENCY:-1}|g" \
    -e "s|__WORKSPACE_USAGE_TIMEOUT_MS__|${WORKSPACE_USAGE_TIMEOUT_MS:-300000}|g" \
    -e "s|__WORKSPACE_USAGE_MIN_SCAN_INTERVAL_MS__|${WORKSPACE_USAGE_MIN_SCAN_INTERVAL_MS:-172800000}|g" \
    -e "s|__WORKSPACE_USAGE_BATCH_SIZE__|${WORKSPACE_USAGE_BATCH_SIZE:-50}|g" \
    ...
    -e "s|__GENERATION_BASE_URL__|${GENERATION_BASE_URL}|g" \
